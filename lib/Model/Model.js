...
class Model extends Shock {
    ...
    static fromRequest(request) {
        ...
        var modeled_class = new this(),
            request_keys  = Object.keys(request.body);

        request_keys.forEach(key => {
            eval(`modeled_class.${key} = request.body[key]`);
        })

        return modeled_class;
    }
    ...
    static isValidDate(request_val, form_val) {
        ...
        const pattern = form_val.pattern != null ?
            /*if*/    pattern = form_val.pattern
            /*else*/: pattern = "MM-DD-YYYY";

        return moment(request_val, pattern, true).isValid()
    }
    ...
    static isValidDateTime(request_val, form_val) {
        ...
        const pattern = form_val.pattern != null ?
            /*if*/    pattern = form_val.pattern
            /*else*/: pattern = "MM-DD-YYYY HH:mm:ss";
