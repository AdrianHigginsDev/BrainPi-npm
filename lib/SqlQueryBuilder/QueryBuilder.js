    ...
    execute() {
        ...
        switch(this.method) {
            ...
            case "update":
                ...
                this.queryRaw = Build.buildUpdate(this.tableQuery, this.params, this.clauses, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;

            case "delete":
                this.queryRaw = Build.buildDelete(this.tableQuery, this.clauses, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;

            case "count":
                this.queryRaw = Build.buildCount(this.tableQuery, this.params, this.clauses, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;
