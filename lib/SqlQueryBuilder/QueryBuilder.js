...
class QueryBuilder {
    ...
    select(params) {
        ...
        if(params.length <= 0)
            throw new Error(`Params Cannot Be Empty In Select()`);
    ...
    execute() {
        ...
        switch(this.method) {
            case "insert":
                ...
                this.queryRaw = Build.buildInsert(this.tableQuery, this.params, this.connection);
                break;

            case "select":
                this.queryRaw = Build.buildSelect(this.tableQuery, this.params, this.clause, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;
            ...
            case "update":
                ...
                this.queryRaw = Build.buildUpdate(this.tableQuery, this.params, this.clause, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;

            case "delete":
                this.queryRaw = Build.buildDelete(this.tableQuery, this.clause, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;

            case "count":
                this.queryRaw = Build.buildCount(this.tableQuery, this.params, this.clause, this.limitQuery, this.offsetQuery, this.orderByQuery, this.connection);
                break;
